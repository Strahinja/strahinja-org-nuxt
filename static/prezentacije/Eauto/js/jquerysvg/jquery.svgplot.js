...
$.extend(SVGPlot.prototype, {
	...
	_drawPlot: function() {
		//console.log('====== _drawPlot(_drawNow = ' + this._drawNow + ') =======');
		if (!this._drawNow) {
			return;
		}
		...
		if (!this._plotCont.width) {
			/*console.log('!plotCont.width, setting width to '
			...
			/*console.log('plotCont.width.baseVal, setting width to '
				+ (this._plotCont.width.baseVal.value || this._wrapper._width())
				+ ' (this._plotCont.width.baseVal.value = ' + this._plotCont.width.baseVal.value
				+ ', this._wrapper._width() = ' + this._wrapper._width()
			);
			console.log('********** this._wrapper.width = ');
			console.log(this._wrapper._width());
			console.log('this._plotCont.width before = ');
			console.log(this._plotCont.width);*/
			if (typeof this._wrapper._width().baseVal !== 'undefined')
			{
				this._plotCont.width.baseVal.valueAsString = this._wrapper._width().baseVal.valueAsString;
				/*console.log('ASSIGNING unitType TO ' + this._wrapper._width().baseVal.unitType);
				this._plotCont.width.baseVal.unitType = this._wrapper._width().baseVal.unitType;
				console.log('ASSIGNING valueISU TO ' + this._wrapper._width().baseVal.valueInSpecifiedUnits);
				this._plotCont.width.baseVal.valueInSpecifiedUnits = this._wrapper._width().baseVal.valueInSpecifiedUnits;*/
			}
			else
			{
			...
			/*console.log('this._plotCont.width after = ');
			console.log(this._plotCont.width);*/
		}
		else {
			/*console.log('else... plotCont.width, setting width to '
				+ (this._plotCont.width || this._wrapper._width()));*/
			this._plotCont.width = this._plotCont.width || this._wrapper._width();
		}
		/*console.log('this = ');
		console.log(this);
		console.log('this._plotCont = ');
		console.log(this._plotCont);
		console.log('this._plotCont.width = ');
		console.log(this._plotCont.width);
		...
		if (!this._plotCont.height) {
			...
			if (typeof this._wrapper._height().baseVal !== 'undefined')
			{
				this._plotCont.height.baseVal.valueAsString = this._wrapper._height().baseVal.valueAsString;
				/*console.log('ASSIGNING unitType TO ' + this._wrapper._width().baseVal.unitType);
				this._plotCont.width.baseVal.unitType = this._wrapper._width().baseVal.unitType;
				console.log('ASSIGNING valueISU TO ' + this._wrapper._width().baseVal.valueInSpecifiedUnits);
				this._plotCont.width.baseVal.valueInSpecifiedUnits = this._wrapper._width().baseVal.valueInSpecifiedUnits;*/
		...
		/*console.log('this.wrapper.rect: x = '
			+ dims[this.X]
			+ ', y = '
			+ dims[this.Y]
			+ ', w = '
	...
	_getDims: function(area) {
		...
		/*console.log('getDims: area = ');
		console.log(area);
		console.log('getDims: w = '
			+ width
			+ ', h = '
			+ height
			+ ', xAx = ['
			+ this.xAxis._scale.min
			+ ', '
			+ this.xAxis._scale.max
			+ ']'
		);*/
	...
	_plotFunction: function(fn, cur) {
		...
		for (var i = 0; i <= fn._points; i++) {
			...
			/*console.log('plotFunction: yAx = ['
				+ this.yAxis._scale.min
				+ ', '
				+ this.yAxis._scale.max
				+ ']'
			);
			console.log('plotFunction: scales = ');
			console.log(scales);
			//console.log('plotFunction: dims = ');
			//console.log(dims);*/
