...
$.extend(SVGWrapper.prototype, {
	...
	_width: function() {
		/*console.log('_width(): this._container.clientWidth = '
			+ (this._container ? this._container.clientWidth : 'undefined')
			+ ', this._svg.width = ' + this._svg.width
		);
		console.log('this._container = ');
		console.log(this._container);
		console.log('this._svg.width = ');
		console.log(this._svg.width);*/
		return (this._container && this._container.clientWidth ? this._container.clientWidth : this._svg.width);
	},

	/* Retrieve the height of the SVG object. */
	_height: function() {
		return (this._container && this._container.clientHeight ? this._container.clientHeight : this._svg.height);
	},
